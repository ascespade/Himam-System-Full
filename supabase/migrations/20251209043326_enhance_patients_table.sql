...
-- Update RLS policies (keep existing service_role policy, add more granular ones)
-- Note: Existing policies remain, we're just ensuring they work with new fields
